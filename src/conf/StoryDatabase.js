...
const allStory = [
    MakeLine('welcome',
    'Congratulations on completing your basic training. You will now be granted access to your personal console. Use it well.'
    ),
    MakeLine('first-play',"This is a simplified view of the weaponry you must defuse and dispose of. Your squad awaits your orders. Show us what you've got, rookie.", Require.OnScreen(types.SCREEN_PLAY_MINES)), 
